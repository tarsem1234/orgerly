    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="{{ active_class(Active::checkUriPattern('admin/wellness/*')) }} treeview">
                    <a>
                        <i class="fa fa-graduation-cap"></i>
                        <span>Wellness</span>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu {{ active_class(Active::checkUriPattern('admin/wellness/*'), 'menu-open') }}" style="display: none; {{ active_class(Active::checkUriPattern('admin/wellness/*'), 'display: block;') }}">
                        <li class="{{ active_class(Active::checkUriPattern('admin/wellness/wellness_categories*')) }}">
                            <a href="{{ route('admin.wellness_categories.index') }}">
                                <i class="fa fa-circle-o"></i>
                                <span>Categories</span>
                            </a>
                        </li>
                        <li class="{{ active_class(Active::checkUriPattern('admin/wellness/wellness_sessions*')) }}">
                            <a href="{{ route('admin.wellness_sessions.index') }}">
                                <i class="fa fa-circle-o"></i>
                                <span>Sessions</span>
                            </a>
                        </li>
