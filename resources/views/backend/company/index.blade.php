...
<div class="box box-success">
    <div class="box-header with-border"> 
        ...
        <div class="box-tools pull-right">
            <a href="companies/create" class="btn btn-primary btn-xs">Add Company</a>
        </div>  
    </div>
    <div class="box-body">
            ...
            <table id="industry-table" class="table table-condensed table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @endif
                        <td>
                            <a href= "{{route('admin.companies.edit',$company->id) }}" class="btn btn-xs btn-info edit-icon-btn">
                                <i class="fa fa-pencil-square-o" data-toggle="tooltip" data-placement="top" data-original-title="Edit"></i>
                            </a>
                            <a data-id='{{ $company->id }}' class="btn btn-xs btn-danger delete-icon-btn">
        ...
        function  deleteIndustry(industryId, $this) {
            swal({
                ...
                $.ajax({
                    ...
                    url: "{{ url('/admin/companies/' ) }}" + "/" + industryId,
