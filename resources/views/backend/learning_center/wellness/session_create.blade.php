        ...
        <div class="box box-success" id="">
            ...
            <div class="box-body">
                <div class="container text-center col-md-12">
                    ...
                    <a href="{{route('admin.wellness_categories.index')}}">Back to categories listing</a>
                </div>
            </div>
    </section>
    <section v-else>
        <div class="box box-success">
            ...
            <div class="box-body">
                <div class="container">
                    @if( isset($categorySession) )
                    {{ html()->modelForm($categorySession, 'PUT', route('admin.wellness_sessions.update', $categorySession['id']))->class('form-horizontal')->acceptsFiles()->open() }}
                    @else
                    {{ html()->form('POST', route('admin.wellness_sessions.store'))->class('form-horizontal')->acceptsFiles()->open() }}
                    @endif
                </div>
...
<script>
    ...
    var errorList = 0;
    var save_session_route = "{{route('admin.wellness_sessions.save')}}";
    new Vue({
        el: '#add_edit_session',
        data: {
