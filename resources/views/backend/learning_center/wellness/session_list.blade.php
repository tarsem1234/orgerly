...
<div class="box box-success">
    <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
            <a href="{{route('admin.wellnesssessionCreate', $category->id)}}" class="btn btn-primary btn-xs">Add Session</a>
        </div>
        @else 
            ...
            <table id="session-table" class="table table-condensed table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href= "{{ route('admin.wellness_sessions.edit',$sessions->id) }}" class="btn btn-xs btn-info edit-icon-btn">
                            ...
                            <a href= "{{ route('admin.wellnesssession.deactivate',$sessions->id) }}" class="btn btn-xs btn-info deactivate-icon-btn button-approved">
                                <i class="fa fa-toggle-on" data-toggle="tooltip" data-placement="top" data-original-title="deactivate"></i>
                            </a>
                            @else
                            <a href= "{{ route('admin.wellnesssession.deactivate',$sessions->id) }}" class="btn btn-xs btn-info deactivate-icon-btn">
                ...
                confirmButtonColor: "#ec6c62"
                    ...
                    function () {
                        $.ajax({
                            ...
                            url: "{{url('/admin/wellness/wellness_sessions/')}}" + "/" + sessionId,
