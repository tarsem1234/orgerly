...
@section ('title', ('Wellness Categories'))
...
<div class="box box-success">
    <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
            <a href="{{ route('admin.wellness_categories.create')}}" class="btn btn-primary btn-xs">Add Category</a>
        </div>
    </div>
    <div class="box-body">
        <div class="table-responsive">
            <table id="category-table" class="table table-condensed table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $index+1 }}</td>
                        <td><a href="{{route('admin.wellness_category.session', $category->id )}}">{{$category->category}}</a></td>
                        <td><a href="{{ route('admin.wellnesssessionCreate',$category->id) }}" class="btn btn-xs btn-info">Add New Session</a></td>
                        <td>
                            <a href= "{{ route('admin.wellness_categories.edit',$category->id) }}" class="btn btn-xs btn-info edit-icon-btn">
                            ...
                            <a href= "{{ route('admin.wellness.deactivate',$category->id) }}" class="btn btn-xs btn-info deactivate-icon-btn button-approved">
                                <i class="fa fa-toggle-on" data-toggle="tooltip" data-placement="top" data-original-title="deactivate"></i>
                            </a>
                            @else
                            <a href= "{{ route('admin.wellness.deactivate',$category->id) }}" class="btn btn-xs btn-info deactivate-icon-btn">
                ...
                confirmButtonColor: "#ec6c62"
                    ...
                    function () {
                        $.ajax({
                            ...
                            url: "{{url('/admin/wellness/wellness_categories/')}}" + "/" + categoryId,
