...
<style>
    #wellness_center{ font-weight: bold;color: #000;}
    .learning-center{
        .l-topic-btns{
            a {
                max-width: 258px;
                        ...
                        <div class="row">  
                            <div class="col-md-12"> 
                                <div class="col-sm-12 col-lg-7  col-md-7 p-zero">
                                    <h5 class="pull-left welcome-learning-center">Welcome to your Wellness Center</h5>
                                </div>
                                    ...
                                    <div class="l-topic-btns text-center">
                                        ...
                                        <div class="col-sm-12 l-topic-btns btns-green-blue all-buttons clearfix">
                                            <div class="row">
                                                ...
                                                @if ($x != 0 && $x % 4 == 0)
                                                @endif
                                                <a data-toggle="tooltip" title="{{ $category->category }}" class="btn btn-blue button" href="{{ route('frontend.wellness.topic',$category->id) }}">
