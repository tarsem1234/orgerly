        ...
        <div class="container">
            ...
            <div class="col-md-12">
                <div id="form_text_main">
                    ...
                    <h2>WELCOME TO THE ORGERLY NETWORK</h2>
                    <p class="m-zero mr-top"> Social decisions often correlate lifestyle preferences with the economics of local communities and surrounding amenities.
                        Use this network to <span class="blue-text">interact</span> with local residents and <span class="blue-text">connect</span> with experienced <span class="blue-text">Orgerly members.</span> 
                    </p> 
