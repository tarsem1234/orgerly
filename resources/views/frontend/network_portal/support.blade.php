            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="contact-banner">
                        <div class="text">Professional Organization Network</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="col-md-12">
                <div id="form_text_main">
                    ...
                    <h2>WELCOME TO THE ORGERLY PROFESSIONAL ORGANIZATION NETWORK</h2>
                    <p class="m-zero mr-top"> This platform was specifically created to <span class="blue-text">connect</span> local businesses and consumers. Leverage these professionals to
                        help<span class="blue-text"> facilitate </span> your wellness & healthcare journey.
                    </p> 
                    <div class="icon-div">
