    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <!--<div class="panel panel-default">
                ...
                <div class="panel-heading"><span class="black-text">Create Your Accounts</span></div>
                @if ($errors->any())
                ...
                @endif
                <div class="">
                    {{ html()->form('POST', route('frontend.userStoreSigner'))->class('form-horizontal')->id('userSignUp')->open() }}
                    ...
                    <div class="form-group old_zipcode">
                        <div class="col-md-12">
                            {{ html()->text('zip_code', !empty($user->zip_code) ? $user->zip_code : '')->id('zip_code')->class('form-control')->placeholder('Zip Code')->isReadonly() }}
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <div class="select formField">
                                ...
                                <select id="county" class="form-control" name="county" data-get_counties="{{route('frontend.getCounties')}}" >
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            {{ html()->textarea('address', !empty($user->user_profile->address) ? $user->user_profile->address : '')->id('formatted_address')->class('form-control text-height')->rows('2')->placeholder('Address') }}
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            {{ html()->number('phone_no', !empty($user->phone_no) ? $user->phone_no : '')->class('form-control')->attribute('placeholder', 'Phone No') }}
                   ...
                   <!-- <div class="form-group">
                        <div class="col-md-12">
                            {{ html()->text('company_name', !empty($user->company_name) ? $user->company_name : '')->class('form-control')->attribute('placeholder', 'Company Name') }}
...
<script src="https://maps.googleapis.com/maps/api/js?region=usa&key=<?= config('settings.google_map_api_key') ?>&libraries=places&loading=async&callback=initMap" type="text/javascript"></script>
<script>
