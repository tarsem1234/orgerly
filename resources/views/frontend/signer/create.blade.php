        ...
        <div class="row">
			...
			<div id="usersignup-form">
				...
				<div class="col-md-12">
				    ...
				    <input id="zip_code" class="form-control" placeholder="Zip Code"  readonly="" name="zip_code" type="text" value="">
				</div><!--col-md-6-->
			    </div>
				...
				<div class="col-md-12">
				    ...
				    <select id="county" class="form-control select2-hidden-accessible select_custom" name="county" data-get_counties="{{route('frontend.getCounties')}}"  data-select2-id="county" tabindex="-1" aria-hidden="true">
			...
			<div class="form-group">
				...
				<textarea id="formatted_address" class="form-control text-height" rows="2" placeholder="Address"  name="address" cols="50"></textarea>
			    </div><!--col-md-6-->
			</div>
			<div class="form-group">
			    <div class="col-md-12">
				 <h4 class="control-label">Enter Phone No:</h4>
				<input class="form-control" id="phone_no" placeholder="Phone No" name="phone_no" type="number" value="">
			    </div><!--col-md-6-->
			</div>
