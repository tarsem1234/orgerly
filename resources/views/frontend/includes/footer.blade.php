        ...
        <div class="container">
            ...
            <div class="col-sm-3 col-xs-6">
                <ul>
                    ...
                    <li><a href="{{ route('frontend.blogs') }}">Orgerly Blog</a></li>
                </ul>
            </div>
            <div class="col-sm-3 col-xs-6">
                <ul>
    ...
    <div class="bg-black">
        <div class="container">
            <div class="col-sm-12 col-xs-12">
                <span>Copyright <?=date("Y")?> © Orgerly Benefits Inc. All rights reserved.</span>
            </div>
        </div>
    </div>       
</footer>