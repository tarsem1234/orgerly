            ...
            <nav class="navbar navbar-default">
                ...
                <div class="collapse navbar-collapse sidebar-nav" id="bs-example-navbar-collapse-1">
                    <ul>
                        ...
                        in_array(config('constant.inverse_user_type.Administrator'), array_column(Auth::user()->roles->toArray(), 'sort')))
                        <li>
                            <a id="wellness_center"  href="{{ route('frontend.wellness.center') }}">
                                <span class="icons-dashboard"><i class="fa fa-file-text-o" aria-hidden="true"></i></span>Wellness Center
                            </a>
                        </li>
                        @endif
                       ...
                       <li>
                            <a id="mysigner" href="{{ route('frontend.signer.index') }}">
                                <span class="icons-dashboard"><i class="fa fa-venus-double" aria-hidden="true"></i></span>Accountability Partners
                            </a>
                        </li>
