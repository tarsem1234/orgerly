                ...
                <div class="right-dashboard-div">
                    <div class="right-dashboard-div-text">
                        <div class="right-content-div">
                            ...
                            <h6>Hello, {{ $user->user_profile->full_name }}</h6>
                            @else
                            <h6>Hello, {{ $user->first_name }} {{ $user->last_name ? $user->last_name : '' }}</h6>
                            @endif
                                        ...
                                        <table width="100%">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    @if($user->user_profile != null)
                                                        <td width="50%">Hello, {{ $user->user_profile->full_name }}</td>
                                                    @else
                                                        <td width="50%">Hello, {{ $user->first_name }} {{ $user->last_name ? $user->last_name : '' }}</td>
                                                    @endif
