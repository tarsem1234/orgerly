...
<div class="dashboard-page profile-view edit-rofile-page">
                    ...
                    <div class="profile right-dashboard-div-text register-page">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="">
                                    <input type="text" class="form-control" id="email" data-rule-required="true" data-rule-email="true" data-msg-required="Please enter email" name="email" value="{{ $user->email??"" }}" aria-required="true">
                                </div>
                            </div>
                            @else
                            <div class="form-group">
    ...
    <?php }
                            ...
                            <div class="form-group">
                                <h4 class="control-label">Company Name</h4>
                                <div class="">
                                    <input type="text" class="form-control" id="company_name" name="company_name" value="{{ $user->user_profile->company_name }}" aria-required="true">
