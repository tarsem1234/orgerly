...
@section ('title', ('Orgerly Benefits'))

@section ('meta_description', ('Orgerly Benefits offers best in class employee benefit solutions for employers in the midsize markets. 
                                Their tech enabled education and wellness programs help keep employees and plan funds healthy.'))
@section ('meta_keywords', ('Employee, Benefits, Wellness, Education, Tech, Technology, Broker, Insurance,
                            Learning, Education, Social, Support, Services, Brokers, Software, App, Google Maps, API,
                            HR, Human, Resources, Human Resources, SHRM, Morale'))
...
<div class="elementor-27">
    ...
    <section>
        ...
        <hr style="border: 2px solid #92C800; margin-bottom: 0px;margin-top: 5px;" />
...
.elementor-27 .elementor-element.elementor-element-bf1f5d5 > .elementor-background-overlay {
    ...
    background-image: linear-gradient(90deg, #262626 50%, #FFFFFF 0%);
    opacity: 1;
}
.elementor-background-overlay_2 {
    background-color: transparent;
    background-image: linear-gradient(90deg, #ffffff 50%, #262626 50%);
    opacity: 1;
}
...
{
    border-block-start: var(--divider-border-width) var(--divider-border-style) #92C800;
    width: 15px;
}
...
@media only screen and (max-width: 768px) {
    ...
    .elementor-27 .elementor-element.elementor-element-bf1f5d5 > .elementor-background-overlay{background-image: linear-gradient(90deg, #262626 100%, #FFFFFF 0%);}
    .elementor-27 .elementor-element.elementor-element-bf1f5d5{padding: 0px;}
    .elementor-background-overlay_2{background-image: linear-gradient(90deg, #ffffff 0%, #262626 0%);}
