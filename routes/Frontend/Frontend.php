...
Route::get('/', [FrontendController::class, 'home2'])->name('index');
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('OnlyUsers')->group(function () {
        ...
        Route::get('account_partner/delete/{id}', [AccountabilityPartnerController::class, 'deletePartner'])->name('delete.account_partner');
        Route::get('account_partner/view/{id}', [AccountabilityPartnerController::class, 'signerView'])->name('account_partner.view');
