...
class Active
{
    ...
    public function checkQuery($key, $value)
    {
        ...
        return ($queryValue == $value) || ($queryValue !== null && $value === false) || (is_array($queryValue) && in_array($value, $queryValue));
    }
    ...
    {
        return $this->route && in_array($this->route->getName(), (array) $routeNames);
    }
    ...
    {
        return $this->action && in_array($this->action, (array) $actions);
    }
    ...
    {
        return $this->controller && in_array($this->controller, (array) $controllers);
    }
